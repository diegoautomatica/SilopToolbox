% Silop Toolbox
% Version 0.7.1 16-Feb-2008
% SiLoP Toolbox, files in directory  silop/
%
%
% AutoAdd
% addalgoritmo  - ADDALGORITMO A√±ade un algoritmo al sistema de procesamiento de las aplicaciones estandar de la toolbox
% addimu        - ADDIMU AÒade un IMU al sistema de procesamiento de las aplicaciones estandar de la toolbox
% buscamaximos  - BUSCAMAXIMOS Detecta todos los m·ximos de una seÒal
% buscamaximosth - BUSCAMAXIMOS Detecta todos los m·ximos de una seÒal despuÈs de aplicar un threshold
% connectsilop  - CONNECTSILOP Conecta el sistema de procesamiento con los sensores previamente especificados
% continuarcaptura - CONTINUARCAPTURA Reanuda la adquisiciÛn de datos tras una llamada a
...
% distancia_raizcuarta - DISTANCIA_RAIZCUARTA Calcula la distancia recorrida en un paso mediante el modelo empÔøΩrico de la raiz cuarta
% ejes_anatomicos - EJES_ANATOMICOS Reorienta los datos obtenidos para que coincidan con los ejes anatÛmicos.
...
% evaluasalto   - EVALUASALTO Estima la duraci√≥n de cada salto individual en funci√≥n de los datos devueltos
% evaluasentadillas - EVALUASENTADILLAS Calcula los par·metros m·s relevantes de un conjunto de sentadillas en funciÛn de los datos devueltos
% eventos_RT    - EVENTOSRT Deteccion de Initial Contact y End Contact en Tiempo Real con acelerometro en
% eventosCOGrecto - EVENTOSCOGRECTO Detecta 5 eventos a partir de las acelerariones verticales y horizontales del COG. FunciÔøΩn Off-line
...
% frecuenciapaladas - FRECUENCIAPALADAS Devuelve una se√±al con la frecuencia de palada. 
...
% orientacioncompas - ORIENTACIONCOMPAS Calcula la orientaci√≥n en base a los datos de una br√∫jula/comp√°s situada en el COG
% orientaciongiroscopo - ORIENTACIONGIROSCOPO Calcula la orientaci√≥n en base a los datos de un gir√≥scopo situado en el COG
% orientacionkalman - ORIENTACIONKALMAN Calcula la orientaci√≥n en base a los datos de un gir√≥scopo y un comp√°s situados en el COG
% pararcaptura  - PARARCAPTURA Detiene la adquisiciÛn de datos, pero mantiene el equipo
% playsilop     - PLAYSILOP Realiza el procesamiento de acuerdo a los IMUS y algoritmos indicados
% silopdemo     - % SILOPDEMO Demostraci√≥n de las capacidades de la toolbox
% stopsilop     - STOPSILOP Detiene el procesamiento de las se√±ales, as√≠ como las comunicaciones con los buses 
