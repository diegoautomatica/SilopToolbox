%ALG_EST_DIST_PENDULO Algoritmo para la estimaci�n de la longitud de los pasos mediante el modelo del pendulo
%
%ALG_EST_DIST_PENDULO Algoritmo para la estimaci�n de la longitud de los pasos.
% Este algoritmo actua como  wrapper de la funci�n distancia_pendulo
%Se puede configurar mediante:
%    Config = addalgoritmo(Config, 'alg_est_dist_pendulo', 1, [COG.Acc_Z], [freq,pierna], {'alg_det_event'});
%
...
function resultado = alg_est_dist_pendulo(previos, senhales, params, dependencias)
