...
% alg_est_dist_r4 - ALG_EST_DIST_R4 Algoritmo para la estimacion de la longitud de los pasos mediante el mï¿½todo de la raiz cuarta
...
% alg_est_orient_compas - ALG_EST_ORIENT_COMPAS Algoritmo para la estimacion de la orientaciï¿½n mediante la brï¿½jula
% alg_est_orient_gyro - ALG_EST_ORIENT_GYRO Algoritmo para la estimacion de la orientaciï¿½n mediante el girï¿½scopo
% alg_est_orient_kalman - ALG_EST_ORIENT_KALMAN Algoritmo para la estimacion de la orientaciï¿½n mediante la brï¿½jula y el compas
